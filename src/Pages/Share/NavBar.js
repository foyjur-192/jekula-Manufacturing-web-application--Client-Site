    ...
    <Link to='/login'>Log in</Link>
      ...
      <div class="modal">
        <div class="modal-box w-11/12 max-w-5xl">
          ...
          <div className='flex justify-between mt-5 px-8 py-5 bg-color mb-12'>
            ...
            <div><p className='font-medium text-lg'>Total Complete Order: </p></div>
          </div>
          {
            orders.map(order =>
              <>
                <section class="text-gray-600 body-font overflow-hidden">
                  ...
                  <div class="container px-5 py-12 mx-auto">
                    <div class="-my-8 divide-y-2 divide-gray-100">
                      <div class="py-8 flex items-stretch flex-wrap md:flex-nowrap text-left bg-white shadow px-4">
                        <div class="md:flex-grow">
                          <h2 class="text-lg font-medium text-gray-900 title-font">Product Name: <span className='font-normal text-normal ml-2'>{order.name}</span></h2>
                          <p class="font-medium text-lg">Order Quantity:<span className='font-normal text-normal ml-2'>{order.quantity}</span>Piece</p>
                          <p class="font-medium text-lg">Total Amount: <span className='font-normal text-normal ml-2'>${order.total}</span></p>
                          <p class="font-medium text-lg">Product Model: <span className='font-normal text-normal ml-2'>{order.model}</span></p>
                        </div>
      ...
      <div class="modal">
        <div class="modal-box w-11/12 max-w-5xl">
          ...
          <p className='text-left  mt-5'>Established in 2009, we, Jekula are a leading manufacturer, importer, and exporter, involved in offering a large assortment of Cylinder Liner, Piston Ring, Gudgeon Ring, Con Rod Bearing, Bush Bearing, Thrust Washer, etc. Our reliable product and durability make us the foremost choice for our customers. The whole assortments of our products are manufactured underneath our premises by utilizing excellent quality components and contemporary technology.<br /><br /> These products are widely utilized in many industrial applications. We confirm to deliver high-quality products to the patrons all across the nation. Besides, we deliver our products to various places by dissimilar mode of transportation.
            ...
            Mr.Abdur Rahman (Proprietor) is the mentor of our company. He has complete knowledge of the marketplace and has years of acquaintance in working in this specific field.</p>
          ...
          <div className='flex justify-between bg-gray-900 px-5 text-white py-5'>
            <div className='w-2/5 text-left '>
              <h1 className='font-medium text-2xl mb-3 text-gray-100'>Contact Details</h1>
              <div className='flex  items-stretch'>
                <img src='https://i.ibb.co/kg1hGmN/customer-service-2-1.png' className='w-8 h-8  mb-2 self-center ' />
                <div className='ml-2'>
                  <p className='font-medium text-lg text-gray-100'>Contact Person:</p>
                  <p className='font-normal text-normal'>Agkar Sakarna (Marketing Manager)</p>
                </div>
              </div>
              <div className='flex  items-stretch'>
                <img src='https://i.ibb.co/nM9XKTr/pin-1-2.png' className='w-8 h-8   self-center ' />
                <div className='ml-2'>
                  <p className='font-medium text-lg text-gray-100 mt-5'>Address:</p>
              ...
              <div className='flex  items-stretch'>
                <img src='https://i.ibb.co/V06YH9t/smartphone-1-2.png' className='w-8 h-8  self-center ' />
                <div className='ml-2'>
                  <p className='font-medium text-lg mt-5 text-gray-100'>Call us:</p>
            ...
            <div className='w-3/5 text-left'>
              ...
              <form onSubmit={sendMail} >
                <div class="form-control w-full mt-5 mb-3">
                  ...
                  <input type="text" name='name' placeholder="Name" required class="text-black input  border-white bg-none w-full " />

                </div>
                <div class="form-control w-full mb-3 ">

                  <input type="text" name='email' placeholder="Email" required class="input input-bordered text-black w-full " />

                </div>
                <textarea class="textarea input-bordered w-full text-black" name="message" placeholder="Message" required></textarea>
            ...
            <div className='w-3/5 text-left'>
              ...
              <form onSubmit={sendMail}>
                <div class="form-control w-full mt-5 mb-3">
                  ...
                  <input type="text" name='name' Required placeholder="Name" class="text-black input  border-white bg-none w-full " />

                </div>
                <div class="form-control w-full mb-3 ">

                  <input type="text" name='email' Required placeholder="Email" class="input input-bordered text-black w-full " />

                </div>
                <textarea type="text" name='message' Required class="textarea input-bordered w-full text-black" placeholder="Message"></textarea>
