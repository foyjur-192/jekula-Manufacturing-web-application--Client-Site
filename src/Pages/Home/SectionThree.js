...
import useDetails from '../../Hook/Details';
...
<label for="my-modal-1"  onClick={() => changeContent(inventory)} class="cursor-pointer uppercase font-medium btn bg-color border-none text-black hover:text-white ">Details</label>
</div>
        </div>
...
popUpContents.map(inventory =>
...

  {
      total.map(totals => 
        <>
        <p className='font-medium text-xl mb-5'>Total Price: ${totals}</p>
...
<div class="modal modal-bottom sm:modal-middle">
  ...
  <form className='mt-5' onSubmit={handleOrder}>
   ...
   <div>
    ...
    <div className='text-left mt-48'> <p className='font-medium text-lg'>Description</p>
